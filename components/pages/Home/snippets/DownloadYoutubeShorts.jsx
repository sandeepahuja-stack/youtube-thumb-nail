  ...
  return (
    ...
    <div className=" py-5">
      ...
      <div className="container">
        ...
        <div className="pb-3 ">
          <h2 className="m-0 h2 text-center">How to Download YouTube Shorts</h2>
        </div>
            ...
            <p>This was the easiest way to download YouTube shorts videos to your phone. We have provided step by step tutorial with images. I hope you would be able to download the videos now.</p>
